...
#                                                                             
# PROGRAMMER: Ahmad Siar
# DATE CREATED: 12/06/2023                               
# REVISED DATE: 01/10/2023
...
def calculates_results_stats(results_dic):
    ...
    # number of images in results_dic that are not of a dog
    results_stats_dic['n_notdogs_img'] = (results_stats_dic['n_images'] - 
                                      results_stats_dic['n_dogs_img']) 
    # Optional
    # percentage of pet labels maches with classifier labels (pet labels are in classifier labels or results_dic[key][2] = 1)
    ...
    # percentage of dogs classified correctly (number of correct dogs/number of total dogs)*100
